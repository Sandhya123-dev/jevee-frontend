  ...
  return (
    <div className='max-w-full'>
      ...
      <div className='container h-[50px] md:h-[72px] grid grid-cols-5 md:grid-cols-4 lg:grid-cols-12 my-auto items-center justify-between'>
        ...
        <Link to="/" className='min-h-[15px] min-w-[72px] md:h-[21px] md:w-[102px]'>
        ...
        <ul className='flex items-center justify-between col-span-3 md:col-span-3 lg:col-span-10'>
         ...
         <input type="search" className='outline-none bg-transparent px-2' placeholder='Search brands'/>
         </div>
...
<li className='flex py-2 px-6 gap-4 items-center border-b'><SlLogin className='text-xl'/><h2>Login</h2></li>
         ...
         <li className='cursor-pointer'><BsCart2 className='text-2xl'/></li>
         <li className='cursor-pointer'><PiBellRingingLight className='text-2xl'/></li>
         ...
         <IoIosArrowDown />
         {
          showflag && <div className='absolute bg-white right-0 top-9 flex flex-col items-center justify-center py-1 border z-30 rounded-sm'>
           ...
           <div className='h-[20px] w-[30px] bg-cover'>
            <img src="../np-flag.png" alt="" className='w-full h-full'/>
            </div>
